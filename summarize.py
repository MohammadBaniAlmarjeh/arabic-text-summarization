...
max_length_input = 177
max_length_output = 40
...
sample_output, sample_h, sample_c = encoder(tf.random.uniform((BATCH_SIZE, 124))) #encoder(example_input_batch)
...
def generate_seq2seq(text):
    return beam_translate_sent([text, text])[0]
